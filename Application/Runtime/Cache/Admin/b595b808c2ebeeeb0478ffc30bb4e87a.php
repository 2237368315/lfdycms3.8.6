    ...
    <div class="line-big">
        <div class="panel">
            ...
            <ul class="list-group">
                ...
                <li><span class="float-right badge bg-red"><?php echo ($info["comment"]); ?></span><span class="icon-comment"></span> 评论</li>
        ...
        <div class="panel">
            ...
            <table class="table">
                <tr>
                    <td width="200" align="right">操作系统：</td><td><?php echo (PHP_OS); ?></td>
                    <td width="200" align="right">运行环境：</td><td><?php echo ($_SERVER['SERVER_SOFTWARE']); ?></td>
                </tr>
                <tr>
                    <td align="right">MYSQL版本：</td><?php $system_info_mysql = M()->query("select version() as v;"); ?><td><?php echo ($system_info_mysql["0"]["v"]); ?></td>
                    <td align="right">上传限制：</td><td><?php echo ini_get('upload_max_filesize');?></td>
                </tr>
                <tr>
                    <td align="right">程序语言：</td><td>PHP</td>
                    <td align="right">系统版本：</td><td><?php echo C('WEB_VERSION');?></td>
                </tr>
                <tr>
                    <td align="right">数据库：</td><td>MySQL</td>
                    <td align="right">官网：</td><td><a class="text-red" href="<?php echo C('UPDATE_URL');?>" target="_blank"><?php echo C('UPDATE_URL');?></a></td>
                </tr>
            </table>
        </div>
    </div>
